                    ...
                    <li>
                        <Link to="/Home" style={{display:"none"}} id="logo">
                            <header className="App-header">
                                ...
                                {
                                  <img src="https://www.kindpng.com/picc/m/403-4034617_jw-marriott-hotel-logo-hd-png-download.png"  
                                  className="App-logo" alt="logo" id="img" width={"100px"}  />
                                }
                            </header>
                        </Link>
                    </li>
                    <li>
                        <div onClick={e=>myfun(e)}>
                            <header className="App-header" id={"logo2"}>
                                <img src="https://www.kindpng.com/picc/m/403-4034617_jw-marriott-hotel-logo-hd-png-download.png"  id="img1"width={"100px"}/>
                            </header>
                        </div>
                    </li>
                    <li class="nav-item">
                        <NavLink to="/Home" id="homeBtn" style={{display:"none",fontSize:"22px"}}className='nav-link'></NavLink>
                    </li>
                    <li class="nav-item">
