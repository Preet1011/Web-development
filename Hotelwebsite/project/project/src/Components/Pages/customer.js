...
export default function Customer() {
  ...
  return (
    <div id="HomeDiv" style={{backgroundImage:"url('https://photographycourse.net/wp-content/uploads/2014/11/Landscape-Photography-steps.jpg')",backgroundAttachment:"fixed",backgroundSize:"cover",height:"17cm",color:"white"}}>
